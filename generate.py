...
AGENT_META = {
    ...
    "嘎拉嘎拉-t2118": {
        ...
        "desc": "老虎機機率與牌庫設計專家",
        "hp": 150,
        "pokemon": "嘎拉嘎拉 Marowak",
        "sprite": f"{SPRITE_BASE}/105.gif",
        "skills": [
    ...
    "傑尼龜-t2123": {
        ...
        "desc": "A/B 測試分析專家",
        "hp": 160,
        "pokemon": "傑尼龜 Squirtle",
        "sprite": f"{SPRITE_BASE}/7.gif",
        "skills": [
    ...
    "達克萊伊-t2130": {
        ...
        "desc": "Git 操作專員",
        "hp": 130,
        "pokemon": "達克萊伊 Darkrai",
        "sprite": f"{SPRITE_BASE}/491.gif",
        "skills": [
        ...
        "rules": [
            ...
            "Repo：github.com/chihsiangchan888/gua-group-dashboard（公開）",
            "本地路徑：/mnt/e/呱集團/",
    ...
    "未知圖騰-t2135": {
        "type": "Psychic",
        "color": "#F85888",
        "desc": "競品遊戲封包抄錄與資訊擷取專員",
        "hp": 90,
        "pokemon": "未知圖騰 Unown",
        "sprite": f"{SPRITE_BASE}/201.gif",
        "skills": [
            {"name": "封包分析", "cost": "🟣", "desc": "操作封包分析工具從競品站台收集老虎機 spin 數據"},
            {"name": "資料整理", "cost": "🟣🟣", "desc": "整理遊戲規格成結構化文件供團隊分析"},
        ],
        "rules": [
            "競品遊戲封包抄錄與資訊擷取專員",
            "操作封包分析工具從競品站台收集老虎機 spin 數據與遊戲規格",
            "整理成結構化文件供團隊分析",
        ],
        "weakness": "Dark",
        "retreat": "⚪",
